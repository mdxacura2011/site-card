...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <meta name="keywords" content="моделирование, конструирование, проектирование, конструирование машин, разработка оборудования, станкостроение, техническое оборудование, промышленное оборудование, поставка оборудования, станки для малого бизнеса, изготовление чертежей, изготовление 3d моделей">
  <meta name="description" content="Производим разработку и конструирование деталей, узлов, станков с чпу. Изготовление чертежей и 3d моделей по ТЗ заказчика.">
  <title>Конструирование в agsmechanic</title>
	...
	<div id="container">
		...
		<div id="wrContent">
			<div id="container_1">
				...
				<div class="konstruirovanie">
						<div id="konstruirovanie_h1"><h1>Конструирование</h1></div>
							<div id="konstruirovanie_text">
								<p>Занимаясь производством станков с ЧПУ и <a href="metalloobrabotka.php"><b>металлообработкой</b></a> agsmechanic получил большой опыт для того чтобы воплотить в жизнь любую инженерную идею относящуюся к машиностроению. 
								 </br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Вся конструкторская документация имеет три стадии:
								</br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;1. Получение ТЗ от заказчика, в котором описываются все технические требования к изготовляемому изделию.
								</br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;2. Разработка 3D модели, которая помогает визуализировать и увидеть практически все особенности данного изделия. 
								</br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;3. Изготовление рабочих чертежей, по которым будет происходить  дальнейшее изготовление деталей, узлов и окончательная сборка.
								</br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Используемая нами конструкторская документация  в производстве серийных изделий, таких как <a href="frezernie-chpu.php"><b>фрезерно-гравировальные</b></a> станки ЧПУ и <a href="frezernie-chpu.php"><b>машины термической резки</b></a> (плазма) с ЧПУ может изменяться под необходимые технические требования с Вашей стороны, которые в полной мере удовлетворят все Ваши производственные потребности.
								</p>
							</div>
						<div id="cherteg"><img src="images/cherteg.png" alt="Конструирование и изготовление деталей и оборудования с ЧПУ" title="AGS MECHANIC - изготовление чертежей, 3d моделей и станков с ЧПУ" width="900" height="608"></div>
				</div>
				<div class="clear"></div>
				</div>
